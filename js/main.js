(function ($) {
    ...
    ///////////////////////////////////////////////////// Your
    var venueAddress = "Pavlinska ulica 2, Varaždin"; // Venue
    /////////////////////////////////////////////////// Adress
        ...
        ContactForm: function () {
            $("#contact-form").submit(function (e) {
                ...
                if (isValidEmail(email) && (name.length > 1)) {
                    ...
                    if (!isValidEmail(email)) {
                        $('input#contact-email').addClass('not-valid');
                    } else {
                        $('input#contact-email').removeClass('not-valid');
                    }
                    if (name.length === 0) {
                        $('input#contact-name').addClass('not-valid');
                    } else {
                        $('input#contact-name').removeClass('not-valid');
                    }
                }
                return false;
            });
